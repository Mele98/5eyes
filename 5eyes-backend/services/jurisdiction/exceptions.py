...
class JurisdictionReferenceDataMissingError(ValueError):
...
class JurisdictionReferenceDataConflictError(ValueError):
    """Mehrere aktive Referenzzeilen machen die Modellauswahl mehrdeutig."""
