...
def upsert_foundation_example_case(db: Session, user: User) -> dict:
    ...
    assessment = RiskAssessment(
        ...
        income_sources_json='["Berufliche Taetigkeit","Vermoegensanlagen"]',
        assessed_at=now,
        assessed_by=user.id,
        created_at=now,
        updated_at=now,
    ...
    answers = [
        ("Kenntnisse & Erfahrungen", 1, "Finanzdienstleistungen: {}", 0),
        ("Kenntnisse & Erfahrungen", 2, "Finanzinstrumente: {}", 0),
        ("Risikof\u00e4higkeit", 3, "Ueber CHF 20'000", 4),
        ("Risikof\u00e4higkeit", 4, "Herkunft: Berufliche Taetigkeit, Vermoegensanlagen", 0),
        ("Risikof\u00e4higkeit", 5, "Bis CHF 3'000", 4),
        ("Risikof\u00e4higkeit", 6, "Ueber CHF 2'000'000", 12),
        ("Risikof\u00e4higkeit", 7, "Ueber 50 %", 12),
